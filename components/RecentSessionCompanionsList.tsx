...
interface RecentSessionCompanionListProps {
    title: string;
    recent?: {
        sessionId: string;
        companion: Companion;
            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead className="text-lg text-right">Session ID</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {recent?.map(({ sessionId, companion }) => (
...
export default RecentSessionCompanionList;
